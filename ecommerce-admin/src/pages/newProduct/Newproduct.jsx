  ...
  console.log(file)
    ...
    return (
        <div className="newProduct">
          ...
          <div className="addProductItem">
              <label>Price</label>
              <input type="number" name='price' placeholder="200" onChange={handleChange}/>
          </div>
          <div className="addProductItem" onChange={handleCategories}>
              <label>Categories</label>
              <input type="text" placeholder="Tshirt , Jeans" />
            </div>
            <div className="addProductItem">
              <label>Stock</label>
